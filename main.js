...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const enduranceInfo = {
        overview: {
            ...
            description: "24시간 내구 레이스는 단순히 속도만을 겨루는 경기가 아닙니다. 인간의 체력, 자동차의 신뢰성, 그리고 팀의 전략이 완벽한 조화를 이루어야 하는 가장 가혹한 모터스포츠입니다. 낮과 밤, 그리고 변화무쌍한 날씨 속에서 수천 킬로미터를 질주하는 이 경기는 '모터스포츠의 에베레스트'라 불립니다."
        },
        rules: [
